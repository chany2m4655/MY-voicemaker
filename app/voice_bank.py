...
VOICE_BANK = [
    ...
    # ==========================================
    {
        ...
        "pitch": "-4Hz",
        "volume": "+0%",
        "desc": "Vrew 1위 송세아/미정 원본 음성 클론 톤 - 지적이고 차분하며 편안한 라디오/오디오북 낭독 톤",
        "sample_text": "이야기의 결말이 궁금하시다면, 영상 끝까지 시청해 주세요. 그럼 지금부터, 오늘의 사연을 시작하겠습니다."
    },
    {
        "id": "NARRATION_GACRUX",
        "name": "가크룩스 (남성 프리미엄 내레이터)",
        "category": "내레이션",
        "gender": "male",
        "age_group": "중년/노년",
        "role_type": "해설",
        "voice": "gemini-tts-Gacrux",
        "rate": "+0%",
        "pitch": "+0Hz",
        "volume": "+0%",
        "desc": "Google Gemini 2.5 Flash 프리미엄 TTS Gacrux - 가슴을 울리는 중후하고 깊은 명품 인생사연 낭독 톤",
